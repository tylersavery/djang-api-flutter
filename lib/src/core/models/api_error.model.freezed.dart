...
abstract class $ApiErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String detail, String code});
}
...
class _$ApiErrorImpl implements _ApiError {
  const _$ApiErrorImpl({this.detail = "Unknown error", this.code = "unknown"});
  ...
  @override
  String toString() {
    return 'ApiError(detail: $detail, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, detail, code);
...
abstract class _ApiError implements ApiError {
  const factory _ApiError({final String detail, final String code}) =
      _$ApiErrorImpl;
